...
{
	var $table = 'data_user';
	var $column_order = array('log_id', 'log_nama', 'log_email', 'log_user', 'log_level', 'log_aktif'); //set column field database for datatable orderable
	var $column_search = array('log_id', 'log_nama', 'log_email', 'log_user', 'log_level'); //set column field database for datatable searchable just firstname , lastname , address are searchable
