...
<div class="modal fade" id="modal_kategori_produk" tabindex="-1" aria-hidden="true">
...
<script>
	...
	function tambah() {
		...
		var myModal = new bootstrap.Modal(document.getElementById('modal_kategori_produk'));
		myModal.show();
	}
		...
		$.ajax({
			...
			success: function(d) {
				...
				if (res.success) {
					...
					drawTable();
					reset_form();
					bootstrap.Modal.getInstance(document.getElementById('modal_kategori_produk')).hide();
				} else {
